...
function HiringAdmin({ user, departments, employees, setEmployees }: any) {
  // Reuse the employee-facing Hiring component in the admin panel
  const HiringComponent = require('../components/employee/Hiring').default
...
function LocationsAdmin({ user, locations, setLocations }: any) {
  const LocationsComponent = require('../components/employee/Locations').default
