...
const EMPLOYEE_NAV: NavItem[] = [
  ...
  { key: 'shiftswap',    label: 'Shift Swap',   icon: '🔄' },
  { key: 'payroll',      label: 'My Payslips',  icon: '💰' },
  { key: 'announcements',label: 'Announcements',icon: '📢' },
  { key: 'recognitions', label: 'Recognitions', icon: '🌟' },
  { key: 'moodcheckin',  label: 'Mood Check-in',icon: '😊' },
...
export default function Home() {
  ...
  useEffect(() => {
    if (user) {
      ...
      const ch = supabase.channel('global-rt')
