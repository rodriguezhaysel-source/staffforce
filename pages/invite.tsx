...
export default function InvitePage() {
  ...
  async function handleActivate() {
    ...
    // Notify owner in panel audit log so it shows as a panel event
    await supabase.from('panel_audit_log').insert({
      panel_user_id: 'system',
      panel_user_email: 'system',
      panel_user_name: 'System',
...
// patch: notify owner on activation — appended below handleActivate
